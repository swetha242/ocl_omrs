...
class OclOpenmrsHelper(object):
    ...
    SOURCE_DIRECTORY = [
        ...
        {'owner_type':'org', 'owner_id':'Regenstrief', 'omrs_id':'LOINC', 'ocl_id':'LOINC'},
        {'owner_type':'org', 'owner_id':'WHO', 'omrs_id':'ICD-10-WHO NP', 'ocl_id':'ICD-10-WHO-NP'},
        {'owner_type':'org', 'owner_id':'WHO', 'omrs_id':'ICD-10-WHO 2nd', 'ocl_id':'ICD-10-WHO-2nd'},
        {'owner_type':'org', 'owner_id':'WHO', 'omrs_id':'ICD-10-WHO NP2', 'ocl_id':'ICD-10-WHO-NP2'},
        {'owner_type':'org', 'owner_id':'HL7', 'omrs_id':'HL-7 CVX', 'ocl_id':'HL-7-CVX'},
        {'owner_type':'org', 'owner_id':'PIH', 'omrs_id':'PIH', 'ocl_id':'PIH'},
	...
	{'owner_type':'org', 'owner_id':'OpenMRS', 'omrs_id':'org.openmrs.module.bacteriology', 'ocl_id':'org.openmrs.module.bacteriology'},
        ...
        {'owner_type':'org', 'owner_id':'3BT', 'omrs_id':'3BT', 'ocl_id':'3BT'},
        ...
        {'owner_type':'org', 'owner_id':'WHO', 'omrs_id':'Pharmacologic Drug Class', 'ocl_id':'Pharmacologic-Drug-Class'},
        {'owner_type':'org', 'owner_id':'VHA', 'omrs_id':'NDF-RT NUI', 'ocl_id':'NDF-RT-NUI'},
        {'owner_type':'org', 'owner_id':'FDA', 'omrs_id':'FDA Route of Administration', 'ocl_id':'FDA-Route-of-Administration'},
